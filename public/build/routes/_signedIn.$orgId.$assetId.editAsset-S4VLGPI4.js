...
// app/routes/_signedIn.$orgId.$assetId.editAsset.tsx
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/_signedIn.$orgId.$assetId.editAsset.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706454925351.0757";
}
function EditAsset() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "self-start py-4 md:py-8", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: " text-gray-500", children: [
      ...
      " /",
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: " font-semibold underline", children: "Edit Asset" }, void 0, false, {
        fileName: "app/routes/_signedIn.$orgId.$assetId.editAsset.tsx",
        lineNumber: 101,
        columnNumber: 9
      }, this)
    ] }, void 0, true, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: `${pageTitle} p-1`, children: "Edit Asset" }, void 0, false, {
      fileName: "app/routes/_signedIn.$orgId.$assetId.editAsset.tsx",
      lineNumber: 103,
      columnNumber: 7
    }, this),
...
//# sourceMappingURL=/build/routes/_signedIn.$orgId.$assetId.editAsset-S4VLGPI4.js.map
